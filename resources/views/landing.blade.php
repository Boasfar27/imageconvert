            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    <div class="flex items-center">
                        ...
                        <div class="flex items-center cursor-pointer group" onclick="window.location.reload()">
                            <span
                                class="text-2xl sm:text-3xl font-bold text-indigo-600 dark:text-indigo-400">Boas</span>
                    ...
                    <div class="hidden md:flex items-center space-x-6">
                        <a href="{{ route('login') }}"
                            class="text-gray-300 hover:text-indigo-400 text-base font-medium flex items-center">
                            <i class="fas fa-sign-in-alt mr-2"></i>
                            Sign In
                        </a>
                        <a href="{{ route('register') }}"
                            class="gradient-bg text-white px-6 py-3 rounded-2xl text-base font-medium shadow-lg hover:shadow-xl transition duration-300 ease-in-out transform hover:-translate-y-0.5 flex items-center">
                    ...
                    <div class="md:hidden flex items-center">
                        <button id="mobile-menu-button"
                            class="text-gray-200 hover:text-white focus:outline-none relative w-10 h-10 flex items-center justify-center">
                            <i class="fas fa-bars text-2xl transition-all duration-300" id="menu-open-icon"></i>
                            <i class="fas fa-times text-2xl transition-all duration-300 absolute opacity-0"
                ...
                <div id="mobile-menu" class="hidden md:hidden">
                    <div class="px-2 pt-2 pb-3 space-y-3 bg-gray-900/90 backdrop-blur-lg rounded-lg mt-2">
                        <a href="{{ route('login') }}"
                            class="block text-gray-300 hover:text-white hover:bg-gray-700 px-3 py-2 rounded-lg transition duration-300 flex items-center">
                            <i class="fas fa-sign-in-alt mr-2"></i>
                            Sign In
                        </a>
                        <a href="{{ route('register') }}"
                            class="block gradient-bg text-white px-3 py-2 rounded-lg transition duration-300 flex items-center">
                            <i class="fas fa-user-plus mr-2"></i>
                            Start Free
                        </a>
                    </div>
        ...
        <main class="flex-grow">
                ...
                <div class="hero-gradient hero-section">
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                        <div class="text-center relative z-10">
                            ...
                            <h2
                                class="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold leading-[1.2] sm:leading-[1.3] lg:leading-[1.4] tracking-tight mb-6 sm:mb-8 lg:mb-10">
                                <span
                                    class="inline-block bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-indigo-600 mb-2 sm:mb-3">
                                    Transform Your Images to
                                </span>
                                <span class="block text-white relative mt-2 sm:mt-3">
                                    Next-Gen WebP
                                    <div
                                        class="absolute -bottom-3 sm:-bottom-4 left-0 w-full h-2 bg-gradient-to-r from-yellow-400 to-orange-500 transform -skew-x-12">
                                    </div>
                                </span>
                            </h2>
                            ...
                            <div
                                class="mt-12 flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                                <a href="{{ route('register') }}"
                                    class="group bg-white text-primary-600 px-8 py-4 rounded-lg font-bold shadow-lg hover:shadow-xl transition duration-300 ease-in-out transform hover:-translate-y-0.5">
                                    <i class="fas fa-rocket mr-2 group-hover:animate-bounce"></i>
                                    Start Converting Now
                                    <i
                                        class="fas fa-arrow-right ml-3 transform transition-transform group-hover:translate-x-2"></i>
                                </a>
                                <a href="#features"
                                    class="group border-2 border-white text-white px-8 py-4 rounded-lg font-bold hover:bg-gradient-to-r from-blue-400 to-indigo-600 hover:text-white transition duration-300">
            ...
            <div id="features" class="section-blur py-20 relative overflow-hidden">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div class="text-center mb-16">
                        <h3
                            class="text-3xl font-bold text-white inline-block bg-gradient-to-r from-primary-400 to-blue-600 bg-clip-text text-transparent">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div
                            class="feature-card rounded-xl shadow-lg overflow-hidden transform transition duration-500 hover:scale-105 hover:shadow-2xl">
                            <div class="p-8 flex flex-col items-center text-center">
                                <div
                                    class="w-20 h-20 gradient-bg rounded-2xl flex items-center justify-center mb-6 transform transition-transform duration-500 hover:rotate-12">
                                ...
                                <p class="text-gray-600 max-w-sm mx-auto">
                                    State-of-the-art compression algorithm that reduces file size without compromising
                                    quality.
                                </p>
                            </div>
                        </div>
            ...
            <div class="section-blur py-12 sm:py-20">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h3 class="text-2xl sm:text-3xl font-bold text-white mb-6 sm:mb-8">Ready to Optimize Your Images?
                    </h3>
                    <a href="{{ route('register') }}"
                        class="inline-flex items-center bg-white text-primary-600 px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-bold shadow-lg hover:shadow-xl transition duration-300 ease-in-out transform hover:-translate-y-0.5 group">
                        <i class="fas fa-rocket mr-2 sm:mr-3 group-hover:animate-bounce"></i>
                        <span class="text-sm sm:text-base">Get Started for Free</span>
                        <i
                            class="fas fa-arrow-right ml-2 sm:ml-3 transform transition-transform group-hover:translate-x-2"></i>
                    </a>
                    <div class="mt-6 sm:mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-8 max-w-4xl mx-auto">
                        <div
                            class="flex items-center justify-center text-gray-100 bg-primary-600/10 rounded-lg p-3 sm:p-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-24 gap-8">
                    ...
                    <div class="md:col-span-4">
                        ...
                        <div class="flex space-x-4 mt-6 items-center justify-center">
                            <a href="https://boasfar.my.id/"
                                class="w-10 h-10 rounded-full bg-primary-600/20 flex items-center justify-center text-primary-400 hover:bg-primary-600/30 transition-all duration-300">
                                <i class="fa-solid fa-globe"></i>
                            </a>
                            <a href="https://github.com/Boasfar27"
                                class="w-10 h-10 rounded-full bg-primary-600/20 flex items-center justify-center text-primary-400 hover:bg-primary-600/30 transition-all duration-300">
                            ...
                            <a href="https://www.instagram.com/farhaaan____/"
                                class="w-10 h-10 rounded-full bg-primary-600/20 flex items-center justify-center text-primary-400 hover:bg-primary-600/30 transition-all duration-300">
                                <i class="fab fa-instagram"></i>
                            </a>
                            <a href="https://wa.me/6285158442747"
                                class="w-10 h-10 rounded-full bg-primary-600/20 flex items-center justify-center text-primary-400 hover:bg-primary-600/30 transition-all duration-300">
