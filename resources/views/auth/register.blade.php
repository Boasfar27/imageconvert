    ...
    <div class="w-full max-w-md mx-auto">
        <form method="POST" action="{{ route('register') }}" class="space-y-6">
            ...
            <div>
                ...
                <div class="mt-2 relative">
                    ...
                    <button type="button" id="togglePassword"
                        class="absolute inset-y-0 right-0 pr-3 flex items-center text-sm text-gray-400 dark:text-gray-300 hover:text-gray-600 dark:hover:text-white transition-colors duration-150">
            ...
            <div class="flex items-center justify-between">
                <a class="text-sm text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300 transition duration-150 ease-in-out"
                    href="{{ route('login') }}">
